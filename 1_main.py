...
def main():
    # เมนูเลือกหน้า
    page = st.selectbox("เลือกหน้าที่ต้องการ", ["การเตรียมข้อมูล", "ทฤษฎีของอัลกอริทึมที่พัฒนา","การจัดการข้อมูล","โมเดลที่ KNN และ Decision Tree","Neural Network"])
    ...
    if page == "การเตรียมข้อมูล":
        ...
        page3_app()
    elif page == "โมเดลที่ KNN และ Decision Tree":
        page4_app()
